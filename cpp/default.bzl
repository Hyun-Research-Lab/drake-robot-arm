...
load("@drake//tools/workspace/build_bazel_apple_support:repository.bzl", "build_bazel_apple_support_repository")  # noqa
load("@drake//tools/workspace/buildifier:repository.bzl", "buildifier_repository")
...
load("@drake//tools/workspace/clarabel_cpp_internal:repository.bzl", "clarabel_cpp_internal_repository")  # noqa
...
load("@drake//tools/workspace/commons_io:repository.bzl", "commons_io_repository")
load("@drake//tools/workspace/conex_internal:repository.bzl", "conex_internal_repository")  # noqa
load("@drake//tools/workspace/crate_universe:repository.bzl", "crate_universe_repositories")  # noqa
...
load("@drake//tools/workspace/libjpeg_turbo_internal:repository.bzl", "libjpeg_turbo_internal_repository")  # noqa
load("@drake//tools/workspace/liblapack:repository.bzl", "liblapack_repository")
...
load("@drake//tools/workspace/libpng_internal:repository.bzl", "libpng_internal_repository")  # noqa
load("@drake//tools/workspace/libtiff:repository.bzl", "libtiff_repository")
load("@drake//tools/workspace/libtiff_internal:repository.bzl", "libtiff_internal_repository")  # noqa
...
load("@drake//tools/workspace/nasm:repository.bzl", "nasm_repository")
...
load("@drake//tools/workspace/platforms:repository.bzl", "platforms_repository")
load("@drake//tools/workspace/pybind11:repository.bzl", "pybind11_repository")
load("@drake//tools/workspace/pycodestyle:repository.bzl", "pycodestyle_repository")
...
# load("@drake//tools/workspace/rules_license:repository.bzl", "rules_license_repository")  # noqa
...
load("@drake//tools/workspace/rules_rust_tinyjson:repository.bzl", "rules_rust_tinyjson_repository")  # noqa
load("@drake//tools/workspace/rust_toolchain:repository.bzl", "register_rust_toolchains", "rust_toolchain_repositories")  # noqa
...
load("@drake//tools/workspace/styleguide:repository.bzl", "styleguide_repository")
