...
def main():
    ...
    Parser(plant).AddModels("./resources/bicopter.urdf")
    plant.Finalize()
    ...
    context = plant.GetMyContextFromRoot(root_context=root_context)

    J1 = plant.GetJointByName("J1")
    J3 = plant.GetJointByName("J3")
